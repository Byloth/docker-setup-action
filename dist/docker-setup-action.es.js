...
var require$$1$1 = /* @__PURE__ */ getAugmentedNamespace(__viteBrowserExternal);
var utils$3 = {};
...
const fs = __importStar$3(require$$1$1);
...
(function(exports) {
  ...
  const os2 = __importStar2(require$$1$1);
  const path = __importStar2(require$$1$1);
  ...
  function exportVariable(name, val) {
    ...
    if (filePath) {
      ...
      const commandValue = `${name}<<${delimiter2}${os2.EOL}${convertedVal}${os2.EOL}${delimiter2}`;
...
class Context$2 {
  constructor() {
    ...
    if ({}.GITHUB_EVENT_PATH) {
      if (fs_1.existsSync({}.GITHUB_EVENT_PATH)) {
        this.payload = JSON.parse(fs_1.readFileSync({}.GITHUB_EVENT_PATH, { encoding: "utf8" }));
      } else {
...
(function(module) {
  ...
  const utils$12 = utils.exports;
  const Impl = URLImpl;
  const impl = utils$12.implSymbol;
  function URL2(url) {
  ...
  module.exports = {
    ...
    setup(obj, constructorArgs, privateData) {
      ...
      obj[impl][utils$12.wrapperSymbol] = obj;
    },
    interface: URL2,
    expose: {
      Window: { URL: URL2 },
...
const PassThrough = zlib.PassThrough;
function Body(body) {
  var _this = this;
...
function clone(instance) {
  ...
  if (body instanceof zlib && typeof body.getBoundary !== "function") {
    p1 = new PassThrough();
    p2 = new PassThrough();
    body.pipe(p1);
    body.pipe(p2);
...
const STATUS_CODES = zlib.STATUS_CODES;
class Response {
  constructor() {
...
const URL$1 = zlib.URL || publicApi.URL;
const parse_url = zlib.parse;
const format_url = zlib.format;
...
const streamDestructionSupported = "destroy" in zlib.Readable.prototype;
...
function getNodeRequestOptions(request2) {
  ...
  if (request2.signal && request2.body instanceof zlib.Readable && !streamDestructionSupported) {
...
const URL$1$1 = zlib.URL || publicApi.URL;
const PassThrough$1 = zlib.PassThrough;
...
function fetch(url, opts) {
  ...
  return new fetch.Promise(function(resolve, reject) {
    ...
    const send = (options.protocol === "https:" ? zlib : zlib).request;
    const signal = request2.signal;
    let response = null;
    const abort = function abort2() {
      let error2 = new AbortError("The user aborted a request.");
      reject(error2);
      if (request2.body && request2.body instanceof zlib.Readable) {
...
Octokit.plugins = [];
var distWeb$2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Octokit
}, Symbol.toStringTag, { value: "Module" }));
...
var distWeb$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
var distWeb = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  composePaginateRest,
